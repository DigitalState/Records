    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('
            ...
            VALUES 
                ...
                (6, \'0fa940d3-86b6-4cdd-b328-244a54cf6147\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.authentication.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (7, \'f2718773-c614-41cc-81d6-26dd4ef18170\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.identities.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (8, \'5f92da77-966b-4680-853e-034cf008b644\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.cases.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (9, \'7a0127a2-1546-4eb2-89d1-9f7dda8d179b\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.services.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (10, \'5dbf9c82-8f08-4731-bf4f-a17b9bb926a6\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.records.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (11, \'5bf8fbbd-68a8-4841-8c13-35d691ac006a\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.assets.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (12, \'099c21c8-7b25-409c-b010-dd02a2f204cd\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.cms.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (13, \'54902459-9dba-4027-8071-e570353d4352\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.camunda.host\', \'127.0.0.1\', 1, 1, now(), now()),
                (14, \'075c676d-cee5-41b7-8bd6-c4a23b85fac6\', \'BusinessUnit\', \'11bec012-a73f-45c1-8d2e-53502fa58c23\', \'ds_api.api.formio.host\', \'127.0.0.1\', 1, 1, now(), now());
        ');
